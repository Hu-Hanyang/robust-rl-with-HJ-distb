...
from robust_rl_hj.envs.base import EnvBase
from robust_rl_hj.envs.physics import PyBulletPhysics
from robust_rl_hj.envs.agents import CrazyFlieSimpleAgent, CrazyFlieBulletAgent, CrazyFlieAgentWithDistb
from robust_rl_hj.envs.utils import deg2rad, rad2deg, get_assets_path, Boltzmann
from robust_rl_hj.hj_distbs.FasTrack_data.distur_gener import distur_gener, quat2euler


class HoverBase(EnvBase):
    def __init__(
            self,
            physics,
            control_mode: str,
    ...
    def compute_done(self) -> bool:
        #TODO: need to imitate the gym-pybullet-drones
...
class DroneHoverSimpleEnv(HoverBase):
    def __init__(self,
...
class DroneHoverBulletEnv(HoverBase):
    def __init__(self,
                 aggregate_phy_steps=2,  # sub-steps used to calculate motor dynamics
                 control_mode='PWM',
                 **kwargs):
